...
class Trade():
    ...
    def __init__(self, exp_price: Decimal, unit: Decimal, trade_type: str,
            order_id: int) -> None:
    ...
    def fill_trade(self, exec_price: Decimal) -> Tuple[Decimal, Decimal]:
        ...
        if self.trade_type == 'entry':
            ...
            _delta_upl = (self.exp_price - exec_price) * self.unit
        elif self.trade_type == 'exit':
            _delta_balance = (self.exp_price - exec_price) * self.unit
